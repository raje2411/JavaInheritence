...
class TraingleNewShape5 extends TwoDShapeNew5 { // Sub-class which is an extension of TwoDShapeNew2 super class
	...
	TraingleNewShape5(String s, double w, double h) { // Defined constructor for sub-class only
	...
	TraingleNewShape5(String s, double x) {
		super("Triangle",x);
		style = s;
	}

	TraingleNewShape5(TraingleNewShape5 obj) { //This constructor is created to create a copy of a given object
		super(obj);
		style = obj.style;
	}
